...
<div style="border-top:1.5px solid #e2e8f0;padding-top:8px;margin-top:4px">
  <table style="width:100%">
    <tr>
      <td style="width:50%;vertical-align:top">
        <div style="font-size:7.5pt;color:#666;margin-bottom:6px">Signature</div>
        <div style="border-bottom:1px solid #555;width:160px;margin:22px 0 5px"></div>
        <div style="font-size:9.5pt;font-weight:700">${co?.signatoryName||""}</div>
        ${co?.signatoryTitle ? `<div style="font-size:8pt;color:#555;margin-top:2px">${co.signatoryTitle}</div>`:""}
        <div style="font-size:7.5pt;color:#888;margin-top:3px">
          Authorized Signatory / <span style="font-family:Cairo,Arial,sans-serif" class="notranslate" lang="ar">المفوض بالتوقيع</span>
        </div>
      </td>
      <td style="width:50%;vertical-align:top;text-align:right">
        ${co?.stamp ? `<img src="${co.stamp}" style="max-width:85px;max-height:85px;object-fit:contain;display:inline-block"/>` : ""}
        <div style="font-size:7.5pt;color:#888;margin-top:4px">
          Company Stamp / <span style="font-family:Cairo,Arial,sans-serif" class="notranslate" lang="ar">ختم الشركة</span>
        </div>
      </td>
    </tr>
  </table>
...
<!-- PAGE FOOTER -->
<div style="margin-top:10px;padding-top:5px;border-top:0.5px solid #e8ecf0;display:flex;justify-content:space-between;font-size:7pt;color:#888">
  <span>${co?.name||""}</span>
...
window.onload=function(){setTimeout(function(){window.print()},1200)};
    ...
    if (win) {
      ...
      a.href = blobUrl; a.download = `${invNum}.html`; a.click();
      setTimeout(() => URL.revokeObjectURL(blobUrl), 5000);
      toast.success(`Downloaded as ${invNum}.html`);
    }
  };
