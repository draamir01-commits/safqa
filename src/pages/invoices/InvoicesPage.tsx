  ...
  const exportInvoicePDF = async (inv: Invoice, qrUrl: string) => {
    ...
    const infoRow = (labelEN: string, valEN: string, labelAR: string, valAR: string) =>
      valEN || valAR ? `<tr>
        ...
        <td class="info-label-ar notranslate" dir="rtl" lang="ar">${labelAR}</td>
        <td class="info-val-ar notranslate" dir="rtl" lang="ar">${valAR || ""}</td>
      </tr>` : "";
...
<div class="footer">
  <div>
    ...
    <div class="sig-role">Authorized Signatory / <span class="ar notranslate" dir="rtl" lang="ar">المفوض بالتوقيع</span></div>
  </div>
